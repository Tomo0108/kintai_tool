...
# 出力ファイル名を作成
output_filename = os.path.basename(TEMPLATE_PATH).replace("勤怠表雛形_", f"勤怠表_{year_month}_").replace(".xlsx", "_氏名.xlsx")
...
# Excelに書き込み
write_to_excel(TEMPLATE_PATH, output_path, df_processed, latest_csv)
