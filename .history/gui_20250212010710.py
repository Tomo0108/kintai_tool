...
def run_main():
    ...
    try:
        result = subprocess.run(
            ["python", "main.py", "--name", employee_name, "--file", csv_file, "--template", template_file],
        ...
        print(error_message)  # コマンドプロンプトでも確認できるように出力
...
csv_entry = tk.Entry(root, width=50, font=font_style)  # csv_entry を定義
csv_entry.pack()
...
template_entry = tk.Entry(root, width=50, font=font_style)  # template_entry の定義を修正
